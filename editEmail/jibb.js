...
function Config(apiKey) {
		this.apiKey = apiKey
		this.webURL = "https://app.testing.jibb.ai"
		xapi.Command.WebEngine.MediaAccess.add({ Hostname: "app.testing.jibb.ai", Device: "Camera" })
		JIBB.Config.setApiBaseURL("https://api.testing.jibb.ai")
